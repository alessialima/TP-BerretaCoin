package aed;
//agregamos handle para poder encontrar las transacciones en O(1)
public class Transaccion implements Comparable<Transaccion>, HeapHandle {
    private int id;
    ...
    public boolean equals(Object o) {
        if (this == o) {
            return true;
        }    // si ambas transacciones apuntan al mismo lugar en memoria seran iguales
        else {
            if (o == null || getClass() != o.getClass()) {
             return false;
            } //si es nula o de distinta clase seran distintas
            else {
    ...
    @Override
    public void setHeapIndex(int index) { //seteamos el indice
        heapIndex = index;
    }

    @Override
    public int getHeapIndex() { // vemos el indice
        return heapIndex;
    }
    ...
    public void setNodoLista(ListaEnlazada.Nodo<Transaccion> nodo) { 
        this.nodoLista = nodo; 
    }
    
    public ListaEnlazada.Nodo<Transaccion> getNodoLista() { 
        return nodoLista; 
    }
}